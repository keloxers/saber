          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-12">
                ...
                {{ Form::open(array('route' => 'preguntas.store',  'autocomplete' => 'off', 'enctype' => 'multipart/form-data')) }}
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="btn btn-default" name="file" id="file" title="Buscar una imagen">
                </div>
